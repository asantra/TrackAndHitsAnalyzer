//
// This is for electron+laser/gamma+laser samples. Original code written by Sasha. Too many histograms, eating up too much memory. Should not be used. 
    ...
    if (det_id >= 1000 && det_id <= 1015) {
      ...
      if (pdg == 11){
        if(track_id!=1){
            ...
            if(eneg<=1.0){
                lhist->FillHistW("tracking_planes_background_track_e_process_electrons_zoomed", det, eneg, physprocess, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_z_process_electrons_zoomed", det, vtx_z, physprocess, ev_weight);
            }
      ...
      if (pdg == -11)  {
          if(track_id==1){
            lhist->FillHistW("tracking_planes_signal_track_x_track_y_dipole_positrons", det, xproj, yproj, ev_weight);
        ...
        if(track_id!=1){
            ...
            if(eneg<=1.0){
                lhist->FillHistW("tracking_planes_background_track_e_process_positrons_zoomed", det, eneg, physprocess, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_z_process_positrons_zoomed", det, vtx_z, physprocess, ev_weight);
            }
      ...
      if (pdg == 22)  {
          if(track_id!=1){
            ...
            if(eneg<=1.0){
                lhist->FillHistW("tracking_planes_background_track_e_process_gamma_zoomed", det, eneg, physprocess, ev_weight);
                lhist->FillHistW("tracking_planes_background_vtx_z_process_gamma_zoomed", det, vtx_z, physprocess, ev_weight);
            }
      ...
      if (pdg == 2112)  {
          if(track_id!=1){
            lhist->FillHistW("tracking_planes_background_track_x_neutron", det, xx, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_y_neutron", det, yy, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_x_neutron_sumE", det, xx, ev_weight*eneg);
            lhist->FillHistW("tracking_planes_background_track_e_neutron_log", det, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_z_track_e_neutron_log", det, vtx_z, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_x_track_e_neutron_log", det, vtx_x, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_y_track_e_neutron_log", det, vtx_y, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_x_track_e_neutron_log", det, xx, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_z_neutron", det, vtx_z, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxz_vtxx_neutron", det, vtx_z, vtx_x, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxz_vtxy_neutron", det, vtx_z, vtx_y, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxx_vtxy_neutron", det, vtx_x, vtx_y, ev_weight);
         }
      }
      if (pdg == 2212)  {
          if(track_id!=1){
            lhist->FillHistW("tracking_planes_background_track_x_proton", det, xx, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_y_proton", det, yy, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_x_proton_sumE", det, xx, ev_weight*eneg);
            lhist->FillHistW("tracking_planes_background_track_e_proton_log", det, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_z_track_e_proton_log", det, vtx_z, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_x_track_e_proton_log", det, vtx_x, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_y_track_e_proton_log", det, vtx_y, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_x_track_e_proton_log", det, xx, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_z_proton", det, vtx_z, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxz_vtxx_proton", det, vtx_z, vtx_x, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxz_vtxy_proton", det, vtx_z, vtx_y, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxx_vtxy_proton", det, vtx_x, vtx_y, ev_weight);
         }
      }
      if (pdg == 111)  {
          if(track_id!=1){
            lhist->FillHistW("tracking_planes_background_track_x_pi0", det, xx, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_y_pi0", det, yy, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_x_pi0_sumE", det, xx, ev_weight*eneg);
            lhist->FillHistW("tracking_planes_background_track_e_pi0_log", det, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_z_track_e_pi0_log", det, vtx_z, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_x_track_e_pi0_log", det, vtx_x, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_y_track_e_pi0_log", det, vtx_y, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_x_track_e_pi0_log", det, xx, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_z_pi0", det, vtx_z, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxz_vtxx_pi0", det, vtx_z, vtx_x, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxz_vtxy_pi0", det, vtx_z, vtx_y, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxx_vtxy_pi0", det, vtx_x, vtx_y, ev_weight);
        }
      }
      if (pdg == 211 || pdg == -211)  {
          if(track_id!=1){
            lhist->FillHistW("tracking_planes_background_track_x_pi", det, xx, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_y_pi", det, yy, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_x_pi_sumE", det, xx, ev_weight*eneg);
            lhist->FillHistW("tracking_planes_background_track_e_pi_log", det, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_z_track_e_pi_log", det, vtx_z, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_x_track_e_pi_log", det, vtx_x, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_y_track_e_pi_log", det, vtx_y, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_x_track_e_pi_log", det, xx, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_z_pi", det, vtx_z, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxz_vtxx_pi", det, vtx_z, vtx_x, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxz_vtxy_pi", det, vtx_z, vtx_y, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxx_vtxy_pi", det, vtx_x, vtx_y, ev_weight);
        }
      }
      if (pdg == -13 || pdg == 13)  {
          if(track_id!=1){
            lhist->FillHistW("tracking_planes_background_track_x_muon", det, xx, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_y_muon", det, yy, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_x_muon_sumE", det, xx, ev_weight*eneg);
            lhist->FillHistW("tracking_planes_background_track_e_muon_log", det, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_z_track_e_muon_log", det, vtx_z, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_x_track_e_muon_log", det, vtx_x, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_y_track_e_muon_log", det, vtx_y, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_track_x_track_e_muon_log", det, xx, eneg, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtx_z_muon", det, vtx_z, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxz_vtxx_muon", det, vtx_z, vtx_x, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxz_vtxy_muon", det, vtx_z, vtx_y, ev_weight);
            lhist->FillHistW("tracking_planes_background_vtxx_vtxy_muon", det, vtx_x, vtx_y, ev_weight);
         }
      }
    }
...
//    lhist->DrawHist2D_BT15("ip_n_gamma_n_electrons_scint", "ip_n_gamma_n_electrons_scint", "N_gamma", "N_e", "N", "colz");
  ...
  double binw(1.0), nbx = 1.0;//flist.size();
...
//   lhist->SetLog(c2);
  ...
  ///
  "tracking_planes_signal_track_x_track_y_dipole_positrons",
  ...
  "tracking_planes_background_track_e_positrons_log",
  "tracking_planes_background_track_e_electrons_log",
  "tracking_planes_background_track_x_neutron",
  "tracking_planes_background_track_y_neutron",
  "tracking_planes_background_track_x_neutron_sumE",
  "tracking_planes_background_track_e_neutron_log",
  "tracking_planes_background_vtx_z_track_e_neutron_log",
  "tracking_planes_background_vtx_x_track_e_neutron_log",
  "tracking_planes_background_vtx_y_track_e_neutron_log",
  "tracking_planes_background_track_x_track_e_neutron_log",
  "tracking_planes_background_vtx_z_neutron",
  "tracking_planes_background_vtxz_vtxx_neutron",
  "tracking_planes_background_vtxz_vtxy_neutron",
  "tracking_planes_background_vtxx_vtxy_neutron",
  "tracking_planes_background_track_x_proton",
  "tracking_planes_background_track_y_proton",
  "tracking_planes_background_track_x_proton_sumE",
  "tracking_planes_background_track_e_proton_log",
  "tracking_planes_background_vtx_z_track_e_proton_log",
  "tracking_planes_background_vtx_x_track_e_proton_log",
  "tracking_planes_background_vtx_y_track_e_proton_log",
  "tracking_planes_background_track_x_track_e_proton_log",
  "tracking_planes_background_vtx_z_proton",
  "tracking_planes_background_vtxz_vtxx_proton",
  "tracking_planes_background_vtxz_vtxy_proton",
  "tracking_planes_background_vtxx_vtxy_proton",
  "tracking_planes_background_track_x_pi0",
  "tracking_planes_background_track_y_pi0",
  "tracking_planes_background_track_x_pi0_sumE",
  "tracking_planes_background_track_e_pi0_log",
  "tracking_planes_background_vtx_z_track_e_pi0_log",
  "tracking_planes_background_vtx_x_track_e_pi0_log",
  "tracking_planes_background_vtx_y_track_e_pi0_log",
  "tracking_planes_background_track_x_track_e_pi0_log",
  "tracking_planes_background_vtx_z_pi0",
  "tracking_planes_background_vtxz_vtxx_pi0",
  "tracking_planes_background_vtxz_vtxy_pi0",
  "tracking_planes_background_vtxx_vtxy_pi0",
  "tracking_planes_background_track_x_pi",
  "tracking_planes_background_track_y_pi",
  "tracking_planes_background_track_x_pi_sumE",
  "tracking_planes_background_track_e_pi_log",
  "tracking_planes_background_vtx_z_track_e_pi_log",
  "tracking_planes_background_vtx_x_track_e_pi_log",
  "tracking_planes_background_vtx_y_track_e_pi_log",
  "tracking_planes_background_track_x_track_e_pi_log",
  "tracking_planes_background_vtx_z_pi",
  "tracking_planes_background_vtxz_vtxx_pi",
  "tracking_planes_background_vtxz_vtxy_pi",
  "tracking_planes_background_vtxx_vtxy_pi",
  "tracking_planes_background_track_x_muon",
  "tracking_planes_background_track_y_muon",
  "tracking_planes_background_track_x_muon_sumE",
  "tracking_planes_background_track_e_muon_log",
  "tracking_planes_background_vtx_z_track_e_muon_log",
  "tracking_planes_background_vtx_x_track_e_muon_log",
  "tracking_planes_background_vtx_y_track_e_muon_log",
  "tracking_planes_background_track_x_track_e_muon_log",
  "tracking_planes_background_vtx_z_muon",
  "tracking_planes_background_vtxz_vtxx_muon",
  "tracking_planes_background_vtxz_vtxy_muon",
  "tracking_planes_background_vtxx_vtxy_muon"};
...
void CreateHistograms(MHists *mh) 
{
  ...
  mh->AddHists("tracking_planes_signal_track_x_track_y_dipole_positrons", ndet, 1300, -650.0, 650.0, 50, -25.0, 25.0);
  ...
  mh->AddHists("tracking_planes_signal_track_x_electrons_sumE", ndet, 1300, -650.0, 650.0);
  mh->AddHists("tracking_planes_signal_track_y_electrons", ndet, 2000, -25.0, 25.0);
  mh->AddHists("tracking_planes_signal_vtx_z_electrons", ndet, 2000, -5000, 15000);
  mh->AddHists("tracking_planes_signal_track_xy_electrons", ndet, 1300, -650.0, 650.0, 50, -25.0, 25.0);
  mh->AddHists("tracking_planes_signal_track_x_track_y_dipole_electrons", ndet, 1300, -650.0, 650.0, 50, -25.0, 25.0);
  mh->AddHists("tracking_planes_signal_vtxz_vtxx_electrons", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_signal_vtxz_vtxy_electrons", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_signal_vtxx_vtxy_electrons", ndet, 6000, -3000, 3000, 6000, -3000, 3000);
  ...
  mh->AddHists("tracking_planes_background_track_e_process_positrons_zoomed", ndet, 100, 0, 1, 2020, 0, 2020);
  mh->AddHists("tracking_planes_background_vtx_z_process_positrons_zoomed", ndet, 2000, -5000, 15000, 2020, 0, 2020);
  ...
  mh->AddHists("tracking_planes_background_track_e_process_electrons_zoomed", ndet, 100, 0, 1, 2020, 0, 2020);
  mh->AddHists("tracking_planes_background_vtx_z_process_electrons_zoomed", ndet, 2000, -5000, 15000, 2020, 0, 2020);
  ...
  mh->AddHists("tracking_planes_background_track_e_process_gamma_zoomed", ndet, 100, 0, 1, 2020, 0, 2020);
  mh->AddHists("tracking_planes_background_vtx_z_process_gamma_zoomed", ndet, 2000, -5000, 15000, 2020, 0, 2020);
  ...
  ////
  mh->AddHists("tracking_planes_background_track_x_proton", ndet, 1300, -650, 650);
  mh->AddHists("tracking_planes_background_track_y_proton", ndet, 200, -25, 25);
  mh->AddHists("tracking_planes_background_track_x_proton_sumE", ndet, 1300, -650, 650);
  mh->AddHists("tracking_planes_background_vtx_z_proton", ndet, 2000, -5000, 15000);
  mh->AddHists("tracking_planes_background_vtxz_vtxx_proton", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_background_vtxz_vtxy_proton", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_background_vtxx_vtxy_proton", ndet, 6000, -3000, 3000, 6000, -3000, 3000);
  
  mh->AddHists("tracking_planes_background_track_x_pi", ndet, 1300, -650, 650);
  mh->AddHists("tracking_planes_background_track_y_pi", ndet, 200, -25, 25);
  mh->AddHists("tracking_planes_background_track_x_pi_sumE", ndet, 1300, -650, 650);
  mh->AddHists("tracking_planes_background_vtx_z_pi", ndet, 2000, -5000, 15000);
  mh->AddHists("tracking_planes_background_vtxz_vtxx_pi", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_background_vtxz_vtxy_pi", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_background_vtxx_vtxy_pi", ndet, 6000, -3000, 3000, 6000, -3000, 3000);
  
  
  mh->AddHists("tracking_planes_background_track_x_muon", ndet, 1300, -650, 650);
  mh->AddHists("tracking_planes_background_track_y_muon", ndet, 200, -25, 25);
  mh->AddHists("tracking_planes_background_track_x_muon_sumE", ndet, 1300, -650, 650);
  mh->AddHists("tracking_planes_background_vtx_z_muon", ndet, 2000, -5000, 15000);
  mh->AddHists("tracking_planes_background_vtxz_vtxx_muon", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_background_vtxz_vtxy_muon", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_background_vtxx_vtxy_muon", ndet, 6000, -3000, 3000, 6000, -3000, 3000);
  
  mh->AddHists("tracking_planes_background_track_x_neutron", ndet, 1300, -650, 650);
  mh->AddHists("tracking_planes_background_track_y_neutron", ndet, 200, -25, 25);
  mh->AddHists("tracking_planes_background_track_x_neutron_sumE", ndet, 1300, -650, 650);
  mh->AddHists("tracking_planes_background_vtx_z_neutron", ndet, 2000, -5000, 15000);
  mh->AddHists("tracking_planes_background_vtxz_vtxx_neutron", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_background_vtxz_vtxy_neutron", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_background_vtxx_vtxy_neutron", ndet, 6000, -3000, 3000, 6000, -3000, 3000);
  
  mh->AddHists("tracking_planes_background_track_x_pi0", ndet, 1300, -650, 650);
  mh->AddHists("tracking_planes_background_track_y_pi0", ndet, 200, -25, 25);
  mh->AddHists("tracking_planes_background_track_x_pi0_sumE", ndet, 1300, -650, 650);
  mh->AddHists("tracking_planes_background_vtx_z_pi0", ndet, 2000, -5000, 15000);
  mh->AddHists("tracking_planes_background_vtxz_vtxx_pi0", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_background_vtxz_vtxy_pi0", ndet, 2000, -5000, 15000, 6000, -3000, 3000);
  mh->AddHists("tracking_planes_background_vtxx_vtxy_pi0", ndet, 6000, -3000, 3000, 6000, -3000, 3000);
  ...
  mh->AddHistsLogBin("tracking_planes_background_track_e_proton_log", ndet, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_z_track_e_proton_log", ndet, 2000, -5000, 15000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_x_track_e_proton_log", ndet, 6000, -3000, 3000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_y_track_e_proton_log", ndet, 6000, -3000, 3000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_track_x_track_e_proton_log", ndet, 1300, -650, 650, nbins+1, xpoints);
  
  
  mh->AddHistsLogBin("tracking_planes_background_track_e_neutron_log", ndet, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_z_track_e_neutron_log", ndet, 2000, -5000, 15000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_x_track_e_neutron_log", ndet, 6000, -3000, 3000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_y_track_e_neutron_log", ndet, 6000, -3000, 3000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_track_x_track_e_neutron_log", ndet, 1300, -650, 650, nbins+1, xpoints);
  
  mh->AddHistsLogBin("tracking_planes_background_track_e_pi0_log", ndet, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_z_track_e_pi0_log", ndet, 2000, -5000, 15000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_x_track_e_pi0_log", ndet, 6000, -3000, 3000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_y_track_e_pi0_log", ndet, 6000, -3000, 3000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_track_x_track_e_pi0_log", ndet, 1300, -650, 650, nbins+1, xpoints);
  
  mh->AddHistsLogBin("tracking_planes_background_track_e_pi_log", ndet, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_z_track_e_pi_log", ndet, 2000, -5000, 15000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_x_track_e_pi_log", ndet, 6000, -3000, 3000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_y_track_e_pi_log", ndet, 6000, -3000, 3000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_track_x_track_e_pi_log", ndet, 1300, -650, 650, nbins+1, xpoints);
  
  
  mh->AddHistsLogBin("tracking_planes_background_track_e_muon_log", ndet, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_z_track_e_muon_log", ndet, 2000, -5000, 15000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_x_track_e_muon_log", ndet, 6000, -3000, 3000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_vtx_y_track_e_muon_log", ndet, 6000, -3000, 3000, nbins+1, xpoints);
  mh->AddHistsLogBin("tracking_planes_background_track_x_track_e_muon_log", ndet, 1300, -650, 650, nbins+1, xpoints);
