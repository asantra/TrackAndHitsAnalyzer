...
targetDESY="/afs/desy.de/user/s/santraar/private/Geant4_File_Analyzer/GPlusLaserSignalAndBackgroundHitsAnalyzer"
...
put TracksAndHitsAnalyzer/runHitGLaser.sh $target
