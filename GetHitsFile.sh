...
targetELaserW="/storage/agrp/arkas/AnalyzeHitsElectron"
targetBKGW="/storage/agrp/arkas/AnalyzeHitsGPlusLaser"
targetElectronW="/storage/agrp/arkas/AnalyzeHitsEBeamOnly"
...
get $target/*HitsProperInfo.txt seedingAlgorithm/seedingFromHits/ 
EOF
